...
var ea = B("Opera"),
  ...
  D =
    B("Gecko") &&
    !(-1 != y.toLowerCase().indexOf("webkit") && !B("Edge")) &&
    !(B("Trident") || B("MSIE")) &&
    !B("Edge"),
  E = -1 != y.toLowerCase().indexOf("webkit") && !B("Edge"),
  ga = E && B("Mobile"),
  F = function() {
    var a = g.document;
...
var N = g.document;
M =
  N && C ? F() || ("CSS1Compat" == N.compatMode ? parseInt(K, 10) : 5) : void 0;
var O;
if (!(O = !D && !C)) {
  var P;
  if ((P = C)) P = 9 <= Number(M);
    ...
    if (ga && ha && b) {
      ...
      var c = 0,
        ...
        d = b.setInterval(function() {
          a.closed || 5 == c ? (b.clearInterval(d), Q(a)) : (a.close(), c++);
        }, 150);
    } else a.close(), Q(a);
  },
  Q = function(a) {
...
var ja = function() {
  ...
  function b(a) {
    for (var b = h, c = 0; 64 > c; c += 4)
      b[c / 4] = (a[c] << 24) | (a[c + 1] << 16) | (a[c + 2] << 8) | a[c + 3];
    for (c = 16; 80 > c; c++)
      (a = b[c - 3] ^ b[c - 8] ^ b[c - 14] ^ b[c - 16]),
        (b[c] = ((a << 1) | (a >>> 31)) & 4294967295);
    a = e[0];
    for (var d = e[1], f = e[2], n = e[3], k = e[4], l, m, c = 0; 80 > c; c++)
      40 > c
        ? 20 > c
          ? ((l = n ^ (d & (f ^ n))), (m = 1518500249))
          : ((l = d ^ f ^ n), (m = 1859775393))
        : 60 > c
        ? ((l = (d & f) | (n & (d | f))), (m = 2400959708))
        : ((l = d ^ f ^ n), (m = 3395469782)),
        (l =
          ((((a << 5) | (a >>> 27)) & 4294967295) + l + k + m + b[c]) &
          4294967295),
        (k = n),
        (n = f),
  ...
  function c(a, c) {
    if ("string" === typeof a) {
      ...
      for (var d = [], e = 0, k = a.length; e < k; ++e) d.push(a.charCodeAt(e));
      a = d;
    }
    c || (c = a.length);
    d = 0;
    if (0 == l)
      for (; d + 64 < c; ) b(a.slice(d, d + 64)), (d += 64), (p += 64);
    for (; d < c; )
      if (((f[l++] = a[d++]), p++, 64 == l))
        for (l = 0, b(f); d + 64 < c; )
          b(a.slice(d, d + 64)), (d += 64), (p += 64);
  }
  function d() {
    var a = [],
      d = 8 * p;
    ...
    b(f);
    for (h = d = 0; 5 > h; h++)
      for (var m = 24; 0 <= m; m -= 8) a[d++] = (e[h] >> m) & 255;
    return a;
  }
  for (var e = [], f = [], h = [], k = [128], m = 1; 64 > m; ++m) k[m] = 0;
  var l, p;
  a();
  return {
    reset: a,
    ...
    digestString: function() {
      for (var a = d(), c = "", b = 0; b < a.length; b++)
        c +=
          "0123456789ABCDEF".charAt(Math.floor(a[b] / 16)) +
          "0123456789ABCDEF".charAt(a[b] % 16);
      return c;
    }
  };
};
...
var ma = function(a) {
    ...
    return (
      ((a =
        (c && b ? ["session_state", la(ia(c), b, a || [])].join(" ") : null) ||
        "") &&
        a.substr(14)) ||
      null
    );
      ...
      if (
        ...
        if (3 == c || 4 == c)
          (a = String(b[c - 3] || "")),
            ...
            (c = this.h),
            a
              ? ((d = [a]), c && d.push(c), (c = ka(d.join(" ")).substr(0, 4)))
              : (c = null),
            c === b && (this.j = a);
        this.a &&
          ((a = this.a.indexOf(".")),
          -1 != a &&
            ...
            (this.a =
              a +
              "." +
              ma([this.g, this.i, this.f, this.l, this.j, a]).substr(0, 4))));
...
var oa = function(a, b, c) {
  ...
  T = function(a, b, c) {
    ...
    String(a) == b && 0 <= a
      ? (b = c.j)
        ? ((b = b.split("|")), (a = b.length <= a ? null : b[a] || null))
        : (a = null)
      : (a = null);
    return a;
  },
...
var U,
  ...
  qa = window,
  ra =
    (window.location.href || qa.location.href).match(
      /.*(\?|#|&)usegapi=([^&#]+)/
    ) || [];
"1" === decodeURIComponent(ra[ra.length - 1] || "")
  ...
  : ((W = function(a, b, c, d, e) {
    ...
    (Y = function(a) {
      gadgets.rpc.getTargetOrigin("..") == gadgets.rpc.getOrigin(a) &&
        W("..", "oauth2callback", gadgets.rpc.getAuthToken(".."), void 0, a);
    }),
    (V = function() {
      Z();
    }),
        ...
        try {
          ...
          a = function() {
            if (!e) {
              e = !0;
              try {
                (window.timeoutMap[String(f)] = void 0),
                  delete window.timeoutMap[String(f)];
              } catch (p) {}
              return d.call(this);
            }
          };
          var l = c.setTimeout(a, b);
          f = window.realSetTimeout(a, b);
          window.timeoutMap[String(f)] = l;
          return f;
        } catch (p) {}
        return window.realSetTimeout(a, b);
      }),
...
window.addEventListener
  ? window.addEventListener("load", ya, !1)
  : window.attachEvent("onload", ya);
