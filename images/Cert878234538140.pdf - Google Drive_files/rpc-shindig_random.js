 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var ea = /^(\/[a-zA-Z0-9_\-]+)+$/,
    ...
    ma = function(a) {
      ...
      e = Q(a, "rs");
      a = Q(a, "t");
      return { g: b, version: c, a: d, c: e, f: a };
    },
    P = function(a) {
  ...
  var R = decodeURI("%73cript"),
    ...
    U = function() {
      ...
      for (var c = h.getElementsByTagName(R), d = 0, e = c.length; d < e; ++d) {
        var f = c[d];
        if (
          f.src &&
  ...
  _c: {
    jsl: {
      ci: {
        ...
        csi: { rate: 0.01 },
        client: { perApiBatch: false, rms: "migrated", cors: false },
        isLoggedIn: true,
      ...
      h:
        "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_GB.Wh-fs1KXhmY.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPfzfq3He_PbwDLCgqUjpNJvw4nhg",
      u: "https://apis.google.com/js/rpc:shindig_random.js?onload\u003dinit",
      hee: true,
      fp: "67e2c0dec393312e9256c4a9be56e10162600b7f",
      dpo: false
    },
    fp: "67e2c0dec393312e9256c4a9be56e10162600b7f",
    annotation: [
